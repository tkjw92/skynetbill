...
<head>
    ...
    <link rel="stylesheet" href="https://files.my-apl.my.id/assets/frontend/libraries/bootstrap/css/bootstrap.css">
</head>
                ...
                <table id="table" width="100%" border="0">
                    <tbody>
                        ...
                        <tr>
                            <td>No. Layanan</td>
                            <td>:</td>
                            <td><?= $bill['no_services'] ?></td>
                        </tr>
                        <tr>
                            <td>Periode Tagihan</td>
                            <td>:</td>
                            <td><?= indo_month($bill['month']) ?> <?= $bill['year'] ?></td>
                        </tr>
                        <tr>
