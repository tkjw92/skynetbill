            ...
            <div class="col-lg">
                <div class="box box-primary">
                    <div class="box-body box-profile">
                        <form action="<?= site_url('income/printincome'); ?>" target="blank" method="post">
                            <div class="box">
                                <div class="box-body">
...
<div style="border: 3px solid <?= $backgroundnya ?>;" class="card shadow mb-4">
    <div style="border-bottom: 3px solid <?= $backgroundnya ?>;" class="card-header py-3">
        <h6 class="m-0 font-weight-bold" style="color : <?= $backgroundnya ?>">Data Pemasukan</h6>
            ...
            <div class="modal-content">
                ...
                <div class="modal-body">
                    <form action="<?= site_url('income/edit') ?>" method="POST">
                        ...
                        <div class="form-group">
                            <label for="datepicker">Tanggal</label>
                            <input type="date" name="date_payment" value="<?= $data->date_payment ?>" id="date_payment" class="form-control" required>
                        </div>
                        <div class="form-group">
                            <label for="remark">Keterangan</label>
