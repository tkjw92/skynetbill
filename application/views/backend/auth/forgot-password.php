...
<head>
	...
	<link rel="stylesheet" href="https://files.my-apl.my.id/login/style.css">
...
<body>
	<div class="container">
		<div id="login-box">
			...
			<form action="" method="post" class="user">
				<div class="controls">
					<input type="email" name="email" id="email" placeholder="Masukkan Alamat Email" class="form-control" />
	...
	<script src="https://files.my-apl.my.id/login/script.js"></script>
</body>
