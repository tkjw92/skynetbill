	...
	<div class="col-lg-6">
		<div style="border: 3px solid <?= $backgroundnya ?>;" class="card shadow mb-3">
			<div style="border-bottom: 3px solid <?= $backgroundnya ?>;" class="card-header py-3">
				<h6 class="m-0 font-weight-bold" style="color : <?= $backgroundnya ?>">Payment Saldo</h6>
			</div>
			<div class="row">
				<div class="col-lg-12">
					<?php
					...
					?>
						<?php echo form_open_multipart('payment/editsaldo/' . $id_payment) ?>
						<div class="card-body">
							<div class="row">
								<div class="col-6">
								...
								<div class="col-12">
									<div class="form-group">
										...
										<div class="row">
											...
											<div class="col-6">
												<a href="<?= site_url('saldo/intruksi') ?>" style="margin-top: 3px;" target="_blank" class="btn btn-success form-control">Tes Koneksi Tripay</a>
											</div>
										</div>
									</div>
								</div>
