...
<head>
    ...
    <link rel="stylesheet" href="https://files.my-apl.my.id/assets/mobile/assets/css/style.css">
    <link rel="manifest" href="https://files.my-apl.my.id/assets/mobile/__manifest.json" crossorigin>
...
<body>
    ...
    <script src="https://files.my-apl.my.id/assets/mobile/assets/js/lib/bootstrap.bundle.min.js"></script>
    ...
    <script src="https://files.my-apl.my.id/assets/frontend/libraries/bootstrap/js/bootstrap.js"></script>
</body>
