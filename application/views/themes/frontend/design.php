...
<html lang="en">
	<head>
		...
		<link href="https://files.my-apl.my.id/design/assets/css/blk-design-system.css?v=1.0.0" rel="stylesheet" />
		<link href="https://files.my-apl.my.id/design/assets/demo/demo.css" rel="stylesheet" />
	...
	<body class="profile-page">
		...
		<script src="https://files.my-apl.my.id/design/assets/js/core/jquery.min.js" type="text/javascript"></script>
		<script src="https://files.my-apl.my.id/design/assets/js/core/popper.min.js" type="text/javascript"></script>
		<script src="https://files.my-apl.my.id/design/assets/js/core/bootstrap.min.js" type="text/javascript"></script>
		<script src="https://files.my-apl.my.id/design/assets/js/plugins/perfect-scrollbar.jquery.min.js"></script>
		<script src="https://files.my-apl.my.id/design/assets/js/plugins/bootstrap-switch.js"></script>
		<script src="https://files.my-apl.my.id/design/assets/js/plugins/nouislider.min.js" type="text/javascript"></script>
		<script src="https://files.my-apl.my.id/design/assets/js/plugins/chartjs.min.js"></script>
		<script src="https://files.my-apl.my.id/design/assets/js/plugins/moment.min.js"></script>
		<script src="https://files.my-apl.my.id/design/assets/js/plugins/bootstrap-datetimepicker.js" type="text/javascript"></script>
		<script src="https://files.my-apl.my.id/design/assets/demo/demo.js"></script>
		<script src="https://files.my-apl.my.id/design/assets/js/blk-design-system.min.js?v=1.0.0" type="text/javascript"></script>
	</body>
</html>
