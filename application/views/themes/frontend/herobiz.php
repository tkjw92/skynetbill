...
<html lang="en">
    <head>
        ...
        <link href="https://files.my-apl.my.id/herobiz/assets/vendor/bootstrap/css/bootstrap.min.css" rel="stylesheet">
        <link href="https://files.my-apl.my.id/herobiz/assets/vendor/aos/aos.css" rel="stylesheet">
        <link href="https://files.my-apl.my.id/herobiz/assets/vendor/glightbox/css/glightbox.min.css" rel="stylesheet">
        <link href="https://files.my-apl.my.id/herobiz/assets/vendor/swiper/swiper-bundle.min.css" rel="stylesheet">
        <link href="https://files.my-apl.my.id/herobiz/assets/css/variables.css" rel="stylesheet">
        <link href="https://files.my-apl.my.id/herobiz/assets/css/main.css" rel="stylesheet">
    ...
    <body>
        ...
        <script src="https://files.my-apl.my.id/herobiz/assets/vendor/bootstrap/js/bootstrap.bundle.min.js"></script>
        <script src="https://files.my-apl.my.id/herobiz/assets/vendor/aos/aos.js"></script>
        <script src="https://files.my-apl.my.id/herobiz/assets/vendor/glightbox/js/glightbox.min.js"></script>
        <script src="https://files.my-apl.my.id/herobiz/assets/vendor/isotope-layout/isotope.pkgd.min.js"></script>
        <script src="https://files.my-apl.my.id/herobiz/assets/vendor/swiper/swiper-bundle.min.js"></script>
        <script src="https://files.my-apl.my.id/herobiz/assets/vendor/php-email-form/validate.js"></script>
        <script src="https://files.my-apl.my.id/herobiz/assets/js/main.js"></script>
        <script src="https://files.my-apl.my.id/assets/frontend/libraries/jquery/jquery-3.4.1.min.js"></script>
        <script type="module" src="https://unpkg.com/ionicons@5.5.2/dist/ionicons/ionicons.esm.js"></script>
        <script nomodule src="https://unpkg.com/ionicons@5.5.2/dist/ionicons/ionicons.js"></script>
        <script src="https://files.my-apl.my.id/assets/mobile/assets/js/plugins/splide/splide.min.js"></script>
    </body>
</html>