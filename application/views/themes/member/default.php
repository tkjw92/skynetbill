...
<head>
    ...
    <link href="https://files.my-apl.my.id/assets/template-member/assets/extra-libs/c3/c3.min.css" rel="stylesheet">
    <link href="https://files.my-apl.my.id/assets/template-member/assets/libs/chartist/dist/chartist.min.css" rel="stylesheet">
    <link href="https://files.my-apl.my.id/assets/themify-icons/themify-icons.css" rel="stylesheet">
    <link href="https://files.my-apl.my.id/assets/template-member/assets/extra-libs/jvector/jquery-jvectormap-2.0.2.css" rel="stylesheet" />
    <link href="https://files.my-apl.my.id/assets/template-member/assets/extra-libs/datatables.net-bs4/css/dataTables.bootstrap4.css" rel="stylesheet">
    <link href="https://files.my-apl.my.id/assets/template-member/dist/css/style.min.css" rel="stylesheet">
    <!-- Font Awesome -->
...
<body>
    ...
    <script src="https://files.my-apl.my.id/assets/template-member/assets/libs/jquery/dist/jquery.min.js"></script>
    <script src="https://files.my-apl.my.id/assets/template-member/assets/libs/popper.js/dist/umd/popper.min.js"></script>
    <script src="https://files.my-apl.my.id/assets/template-member/assets/libs/bootstrap/dist/js/bootstrap.min.js"></script>
    <script src="https://files.my-apl.my.id/assets/template-member/dist/js/app-style-switcher.js"></script>
    <script src="https://files.my-apl.my.id/assets/template-member/dist/js/feather.min.js"></script>
    <script src="https://files.my-apl.my.id/assets/template-member/assets/libs/perfect-scrollbar/dist/perfect-scrollbar.jquery.min.js"></script>
    <script src="https://files.my-apl.my.id/assets/template-member/dist/js/sidebarmenu.js"></script>
    <script src="https://files.my-apl.my.id/assets/template-member/dist/js/custom.min.js"></script>
    <script src="https://files.my-apl.my.id/assets/template-member/assets/extra-libs/c3/d3.min.js"></script>
    <script src="https://files.my-apl.my.id/assets/template-member/assets/extra-libs/c3/c3.min.js"></script>
    <script src="https://files.my-apl.my.id/assets/template-member/assets/libs/chartist/dist/chartist.min.js"></script>
    <script src="https://files.my-apl.my.id/assets/template-member/assets/extra-libs/jvector/jquery-jvectormap-2.0.2.min.js"></script>
    <script src="https://files.my-apl.my.id/assets/template-member/assets/extra-libs/jvector/jquery-jvectormap-world-mill-en.js"></script>
    <script src="https://files.my-apl.my.id/assets/template-member/dist/js/pages/dashboards/dashboard1.min.js"></script>
    <script src="https://files.my-apl.my.id/assets/template-member/assets/extra-libs/sparkline/sparkline.js"></script>
    <script src="https://files.my-apl.my.id/assets/template-member/assets/extra-libs/datatables.net/js/jquery.dataTables.min.js"></script>
    <script src="https://files.my-apl.my.id/assets/template-member/dist/js/pages/datatable/datatable-basic.init.js"></script>
</body>
