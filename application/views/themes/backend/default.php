...
<head>
    ...
    <link href="https://files.my-apl.my.id/assets/backend/css/sb-admin-2.css" rel="stylesheet">
...
<body id="page-top" class="sidebar-toggled">
    ...
    <script src="https://files.my-apl.my.id/assets/backend/js/sb-admin-2.js"></script>
