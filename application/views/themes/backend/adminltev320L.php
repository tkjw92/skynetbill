...
<head>
    ...
    <link rel="stylesheet" href="https://files.my-apl.my.id/adminlte320L/plugins/tempusdominus-bootstrap-4/css/tempusdominus-bootstrap-4.min.css">
    <link rel="stylesheet" href="https://files.my-apl.my.id/adminlte320L/plugins/icheck-bootstrap/icheck-bootstrap.min.css">
    <link rel="stylesheet" href="https://files.my-apl.my.id/adminlte320L/plugins/jqvmap/jqvmap.min.css">
    <link rel="stylesheet" href="https://files.my-apl.my.id/adminlte320L/dist/css/adminlte.min.css">
    <link rel="stylesheet" href="https://files.my-apl.my.id/adminlte320L/plugins/overlayScrollbars/css/OverlayScrollbars.min.css">
    <link rel="stylesheet" href="https://files.my-apl.my.id/adminlte320L/plugins/daterangepicker/daterangepicker.css">
    <link rel="stylesheet" href="https://files.my-apl.my.id/adminlte320L/plugins/summernote/summernote-bs4.min.css">
    <link href="https://files.my-apl.my.id/assets/backend/vendor/fontawesome-free/css/all.min.css" rel="stylesheet" type="text/css">
    <link href="https://fonts.googleapis.com/css?family=Nunito:200,200i,300,300i,400,400i,600,600i,700,700i,800,800i,900,900i" rel="stylesheet">
    <link href="https://files.my-apl.my.id/assets/vendor/animsition/animsition.min.css" rel="stylesheet" media="all">
    <link rel="stylesheet" href="https://cdn.datatables.net/buttons/1.6.2/css/buttons.dataTables.min.css">
    <link rel="stylesheet" href="https://cdnjs.cloudflare.com/ajax/libs/font-awesome/4.7.0/css/font-awesome.min.css">
    <link rel="stylesheet" href="https://cdnjs.cloudflare.com/ajax/libs/font-awesome/5.5.0/css/all.min.css">
    <link href="https://files.my-apl.my.id/assets/backend/vendor/datatables/dataTables.bootstrap4.min.css" rel="stylesheet">
    <link href="https://files.my-apl.my.id/assets/backend/css/select2.min.css" rel="stylesheet">
    <link href="https://files.my-apl.my.id/assets/backend/css/bootstrap-select.css" rel="stylesheet">
    <script src="http://maps.googleapis.com/maps/api/js"></script>
    <link rel="stylesheet" href="https://unpkg.com/leaflet@1.7.1/dist/leaflet.css" />
    <link rel="stylesheet" href="https://unpkg.com/leaflet-routing-machine@latest/dist/leaflet-routing-machine.css" />
    <script src="https://unpkg.com/leaflet@1.7.1/dist/leaflet.js"></script>
    <script src="https://unpkg.com/leaflet-routing-machine@latest/dist/leaflet-routing-machine.js"></script>
    <link rel="stylesheet" href="https://files.my-apl.my.id/assets/backend/leaflet-search.css" />
    <script src="https://files.my-apl.my.id/assets/backend/leaflet-search.js"></script>
...
<body class="hold-transition sidebar-mini layout-fixed">
    ...
    <?php if ($user['role_id'] != 1 && $user['role_id'] != 6 && $user['role_id'] != 7) {
        ...
        <div class="content-wrapper" style="padding-left: 10px; padding-right: 10px;">
            <br>
            <script src="https://files.my-apl.my.id/assets/backend/vendor/jquery/jquery.min.js"></script>
    ...
    <script src="https://files.my-apl.my.id/adminlte320L/plugins/jquery/jquery.min.js"></script>
    <script src="https://files.my-apl.my.id/adminlte320L/plugins/jquery-ui/jquery-ui.min.js"></script>
    <script>
      $.widget.bridge('uibutton', $.ui.button)
    </script>
    <script src="https://files.my-apl.my.id/adminlte320L/plugins/bootstrap/js/bootstrap.bundle.min.js"></script>
    <script src="https://files.my-apl.my.id/adminlte320L/plugins/chart.js/Chart.min.js"></script>
    <script src="https://files.my-apl.my.id/adminlte320L/plugins/sparklines/sparkline.js"></script>
    <script src="https://files.my-apl.my.id/adminlte320L/plugins/jqvmap/jquery.vmap.min.js"></script>
    <script src="https://files.my-apl.my.id/adminlte320L/plugins/jqvmap/maps/jquery.vmap.usa.js"></script>
    <script src="https://files.my-apl.my.id/adminlte320L/plugins/jquery-knob/jquery.knob.min.js"></script>
    <script src="https://files.my-apl.my.id/adminlte320L/plugins/moment/moment.min.js"></script>
    <script src="https://files.my-apl.my.id/adminlte320L/plugins/daterangepicker/daterangepicker.js"></script>
    <script src="https://files.my-apl.my.id/adminlte320L/plugins/tempusdominus-bootstrap-4/js/tempusdominus-bootstrap-4.min.js"></script>
    <script src="https://files.my-apl.my.id/adminlte320L/plugins/summernote/summernote-bs4.min.js"></script>
    <script src="https://files.my-apl.my.id/adminlte320L/plugins/overlayScrollbars/js/jquery.overlayScrollbars.min.js"></script>
    <script src="https://files.my-apl.my.id/adminlte320L/dist/js/adminlte.js"></script>
    <script src="https://files.my-apl.my.id/adminlte320L/dist/js/pages/dashboard.js"></script>
    <script src="https://files.my-apl.my.id/assets/backend/js/bootstrap-select.js"></script>
    <script src="https://files.my-apl.my.id/assets/backend/vendor/jquery-easing/jquery.easing.min.js"></script>
    <script src="https://files.my-apl.my.id/assets/backend/vendor/datatables/jquery.dataTables.min.js"></script>
    <script src="https://files.my-apl.my.id/assets/backend/vendor/datatables/dataTables.bootstrap4.min.js"></script>
    <script src="https://files.my-apl.my.id/assets/backend/js/demo/datatables-demo.js"></script>
    <script src="https://files.my-apl.my.id/assets/backend/js/select2.full.min.js"></script>
    ...
    <script src="https://files.my-apl.my.id/assets/js/sweetalert2.all.min.js"></script>
    <script src="https://files.my-apl.my.id/assets/js/myscript.js"></script>
    <script>
